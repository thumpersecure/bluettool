<p align="center">
  <!-- Banner: uses the repo icon so it stays in-tree -->
  <img src="icons/icon-512.svg" alt="BlueTTool Banner" style="width:420px;max-width:90%;height:auto;border-radius:12px;box-shadow:0 6px 24px rgba(0,0,0,0.45)" />
</p>
...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/PWA-Optimized-5A0FC8?style=flat-square" alt="PWA" />
...
The app applies **graceful degradation**: the Classic BT button is disabled in Bluefy with the message *"Classic BT requires Chrome 117+". See [RECOMMENDATIONS.md](RECOMMENDATIONS.md) for detailed guidance on the use of this app for both environments.